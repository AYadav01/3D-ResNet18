...
class UNet(nn.Module):
    ...
    def forward(self, x):
        # print("Incoming input shape:", x.shape)
        x1 = self.inc(x)
        # print("shape after x1:", x1.shape)
        x2 = self.down1(x1)
        # print("shape after x2:", x2.shape)
        x3 = self.down2(x2)
        # print("shape after x3:", x3.shape)
        x3 = self.Dropout(x3)
        x4 = self.down3(x3)
        # print("shape after x4:", x4.shape)
        x5 = self.down4(x4)
        # print("shape after x5:", x5.shape)
        x = self.up1(x5, x4)
        # print("shape after x:", x.shape)
        x = self.up2(x, x3)
        # print("shape after second x:", x.shape)
        x = self.up3(x, x2)
        # print("shape after third x:", x.shape)
        x = self.up4(x, x1)
        # print("shape after fourth x:", x.shape)
        x = self.outc(x)
        # print("shape after final x:", x.shape)
        return x
